...
export default function OnboardingContent({
  ...
  useEffect(() => {
    ...
    if (!attachAutocomplete()) {
      retryId = window.setInterval(() => {
        if (attachAutocomplete() && retryId !== null) {
    ...
    return () => {
      ...
      const googleMaps = (window as any)?.google?.maps
      if (googleMaps?.event?.clearInstanceListeners && autocompleteRef.current) {
  ...
  const canContinue = Boolean(
    teenName.trim() && permitIssueDate.trim() && stateValue.trim()
  )
  ...
  return (
    ...
    >
          ...
          <div className="mt-5 rounded-[24px] border border-[#0A1E5E]/10 bg-[#EEF2F8] p-4 shadow-inner">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                />
                <p className={helperClass}>
                  Start typing and select a suggested address to auto-fill town,
                  ZIP, county, and coordinates.
                </p>
              </div>
      ...
      <BottomPanel open={showTeenPanel} onClose={() => setShowTeenPanel(false)}>
        <div
          className={editPanelScrollClass}
          style={{ WebkitOverflowScrolling: "touch" }}
        >
          ...
          <div className="space-y-4 rounded-2xl border border-[#0A1E5E]/10 bg-[#EEF2F8] p-4">
            ...
            <div>
              ...
              <input
                ...
                value={teenBirthday}
                onChange={(e) =>
                  setTeenBirthday(formatDateInput(e.target.value))
                }
                className={inputBase}
              />
            </div>
        ...
        <div className="space-y-4 pb-10">
          ...
          <div className="rounded-2xl border border-[#0A1E5E]/10 bg-[#EEF2F8] p-4">
            <p className="leading-relaxed text-[#0A1E5E]/82">
              ...
              deadlines, driving-hour progress, and road-test countdowns. Your
              number is never shared or sold.
            </p>
          </div>
