  ...
  return (
    <div className="relative px-4 py-6 max-w-3xl mx-auto text-[#08194A]">
      ...
      <p className="mb-4">
        ...
        hours required by the NJ Motor Vehicle Commission (MVC). We are committed
        to protecting your privacy and being transparent about how your
        information is used. By using NJDrive50, you agree to this Privacy
        Policy.
      </p>
      ...
      <h3 className="text-lg font-semibold mt-4 mb-1">B. Automatically Collected Information</h3>
      <ul className="list-disc ml-6 mb-4">
        <li>Device information such as device type, OS version, and app version.</li>
        <li>Crash and performance analytics.</li>
        <li>Local storage data including driving history and profile data.</li>
      </ul>

      <h3 className="text-lg font-semibold mt-4 mb-1">C. What We Do Not Collect</h3>
      <ul className="list-disc ml-6 mb-4">
        <li>No GPS location tracking.</li>
        <li>No background location.</li>
      ...
      <ul className="list-disc ml-6 mb-4">
        <li>Driving data is stored locally on your device.</li>
        <li>Crash analytics data is retained for up to 90 days.</li>
        <li>Support emails are retained for up to 12 months.</li>
      </ul>
      <p className="mb-4">You may delete all app data at any time by uninstalling the app.</p>
      ...
      <p className="mb-4">
        ...
        comply with COPPA, CCPA, and GDPR principles.
      </p>

      <h2 className="text-xl font-semibold mt-6 mb-2">7. Your Rights</h2>
      <p className="mb-4">
        Depending on your location, you may have the right to access, correct,
        or delete your data. To request data deletion, email
      ...
      <p className="mb-10">For privacy questions or requests: support@njdrive50.com</p>
    </div>
  )
}
