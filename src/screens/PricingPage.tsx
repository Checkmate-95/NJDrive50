          ...
          <section className="rounded-[28px] border border-[#08194A]/10 bg-white px-4 py-5 shadow-[0_8px_24px_rgba(0,0,0,0.05)] sm:px-6 sm:py-6">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
              ...
              <p className="text-sm text-[#08194A]/55">
                Same core features. Choose the billing option that fits your family.
              </p>
            </div>
              ...
              <div className="mt-5 space-y-4">
                <div className="rounded-2xl bg-[#F7F9FC] px-4 py-4">
                  <h3 className="text-sm font-bold text-[#08194A]">
                    Does the free trial apply to both plans?
                  </h3>
                  <p className="mt-2 text-sm leading-6 text-[#08194A]/68">
                    Yes. Families can start with a 7-day free trial before monthly or annual
                    billing begins.
                  </p>
                </div>
                ...
                <div className="rounded-2xl bg-[#F7F9FC] px-4 py-4">
                  <h3 className="text-sm font-bold text-[#08194A]">
                    Are there different features in each plan?
                  </h3>
                  <p className="mt-2 text-sm leading-6 text-[#08194A]/68">
                    No. Monthly and annual include the same NJDrive50 features. The difference is
                    only billing frequency and total cost.
                  </p>
                </div>

                <div className="rounded-2xl bg-[#F7F9FC] px-4 py-4">
                  <h3 className="text-sm font-bold text-[#08194A]">Can I cancel anytime?</h3>
                  <p className="mt-2 text-sm leading-6 text-[#08194A]/68">
                    Yes. Monthly plans can be canceled anytime. Annual plans can be canceled before
                ...
                <div className="rounded-2xl bg-[#F7F9FC] px-4 py-4">
                  <h3 className="text-sm font-bold text-[#08194A]">
                    Which plan is best for most families?
                  </h3>
                  <p className="mt-2 text-sm leading-6 text-[#08194A]/68">
                    Annual is usually the better value if your teen will use NJDrive50 throughout
                    the full permit and road test timeline.
                  </p>
                </div>
              </div>
            </div>
            ...
            <aside className="lg:sticky lg:top-4 lg:self-start">
              <div className="rounded-[28px] border border-white/30 bg-[#08194A] px-5 py-6 text-white shadow-[0_16px_40px_rgba(8,25,74,0.22)]">
                ...
                <div className="mt-5 rounded-2xl bg-white/8 p-4">
                  ...
                  <p className="mt-1 text-sm text-white/62">Includes a 7-day free trial first.</p>
                </div>
