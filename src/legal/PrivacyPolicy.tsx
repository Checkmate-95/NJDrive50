  ...
  return (
    <div className="relative px-4 py-6 max-w-3xl mx-auto text-[#08194A]">
      ...
      <p className="mb-4 text-sm leading-6 text-[#08194A]/75">
        ...
        information is used. By using NJDrive50, you agree to this Privacy Policy.
      </p>
      ...
      <p className="mb-4 text-sm leading-6 text-[#08194A]/75">
        You may delete all app data at any time by uninstalling the app or via
        Settings → Account &amp; Profile → Delete My Data.
      </p>
